  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Alto Fitness',
        short_name: 'Alto',
        description: 'Plateforme de coaching fitness pour coachs et clients.',
        theme_color: '#10b981',
      ...
      workbox: {
        ...
        // Don't precache anything from Supabase / external CDNs — handle at runtime
        ...
        runtimeCaching: [
          ...
          {
            // NEVER cache Supabase REST/Auth/Realtime API calls — always go to network
      ...
      devOptions: {
        enabled: false, // turn on if you need to test SW in dev
      },
    }),
  ],
  resolve: {
