...
import { Home, BarChart3, CalendarDays, MessageSquare, Dumbbell, UserRound } from 'lucide-react'
import { cn } from '@/lib/utils'

const navItems = [
  { to: '/client/dashboard', label: 'Accueil', icon: Home },
  { to: '/client/planning', label: 'Planning', icon: CalendarDays },
  { to: '/client/coach', label: 'Mon Coach', icon: UserRound },
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[220px] flex-col border-r border-border/40 bg-white lg:flex">
      ...
      <div className="border-t border-border/40 p-3">
        <div className="flex items-center gap-2.5 rounded-xl bg-primary/5 px-3 py-2.5">
